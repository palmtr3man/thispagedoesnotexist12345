...
- `ACTIVE_FLIGHT_CODE_DEFAULT` in `seat-request.js` updated from `FL 041926` → `FL 042426` (Apr 21, 2026).
- Alpha test banners remain in all announcement templates — must be stripped before live sends (FL 042426).
